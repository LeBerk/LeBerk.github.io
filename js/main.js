...
document.getElementById('Sup').innerHTML = random_drink(arr1); 

document.getElementById('Suh').innerHTML = random_drink2(arr2); 

document.getElementById('Sut').innerHTML = random_drink3(arr3); 
